<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="{{route('index')}}"><img src='{{asset('img/cat-logo.jpg')}}' alt='website logo' height='30' width='30'></a>
        </div>
        <ul class="nav navbar-nav">
            ...
            <li @if (Request::is('challenges*')) class="active" @endif><a href="{{route('listChallenge')}}">Challenge</a></li>
